...
# Task
Extract Chinese text and its location from a vector PDF using fitz and print the extracted text with its location.

## Install necessary libraries

### Subtask:
Install the `PyMuPDF` library (which is what `fitz` is).

**Reasoning**:
The subtask is to install the `PyMuPDF` library. This can be done using pip in a new cell.
"""
